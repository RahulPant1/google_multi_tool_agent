...
youtube_shorts_agent = LoopAgent(
    ...
    max_iterations=2,
    description="""This agent iteratively executes sub-agents to generate a YouTube Shorts concept.
    It starts with a scriptwriter agent to generate the script, followed by a visualizer agent to generate visual concepts, and finally a formatter agent to combine them into the final Markdown format.""",
